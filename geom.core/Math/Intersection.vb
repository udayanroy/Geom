    ...
    Partial Public Class Intersection
        ...
        Public Shared Function intersectBezier2Bezier2(ByVal a1 As Point, ByVal a2 As Point, ByVal a3 As Point, ByVal b1 As Point, ByVal b2 As Point, ByVal b3 As Point) As Intersection
            ...
            For i As Integer = 0 To roots.Count - 1
                ...
                If (0 <= s And s <= 1) Then
                    Dim xRoots = New Polynomial(-c12.X, -c11.X,
                                -c10.X + c20.X + s * c21.X + s * s * c22.X).getRoots()
                    Dim yRoots = New Polynomial(-c12.Y, -c11.Y,
        ...
        '*
        '*****/
        Public Shared Function intersectBezier2Rectangle(ByVal p1 As Point, ByVal p2 As Point,
        ...
        '*
        '*****/
        Public Shared Function intersectBezier3Line(ByVal p1 As Point, ByVal p2 As Point,
        ...
        '*
        '*****/
        Public Shared Function intersectBezier3Polygon(ByVal p1 As Point, ByVal p2 As Point,
        ...
        '*
        '*****/
        Public Shared Function intersectBezier3Rectangle(ByVal p1 As Point, ByVal p2 As Point,
        ...
        '*
        '*****/
        Public Shared Function intersectBezier2Bezier3(ByVal a1 As Point, ByVal a2 As Point,
